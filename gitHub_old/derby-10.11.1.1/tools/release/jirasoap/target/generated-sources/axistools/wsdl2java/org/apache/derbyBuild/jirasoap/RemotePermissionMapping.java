...
public class RemotePermissionMapping  implements java.io.Serializable {
    private org.apache.derbyBuild.jirasoap.RemotePermission permission;

    private org.apache.derbyBuild.jirasoap.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
           org.apache.derbyBuild.jirasoap.RemotePermission permission,
           org.apache.derbyBuild.jirasoap.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public org.apache.derbyBuild.jirasoap.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(org.apache.derbyBuild.jirasoap.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public org.apache.derbyBuild.jirasoap.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(org.apache.derbyBuild.jirasoap.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
